module Map
  class Room
    ...
    your entire crew. Yor are the last surviving member and your last
    ...
    """
    Lacy for you they made you learn Gothon insults in academy.
    You tell the one Gothon joke you know:
    Lbhe zbgure vf fb sng, jura fur fvgf nebhaq gur ubhfr, fur fvgf nebhaq gur ubhfr.
    The Gothon stops, tries not to laugh, then bust laughing and can't move.
    While he's laughing you run up and shoot him square in the head
    putting him down, then jump through the Weapon Armory door.

    You do a dive roll into the Weapon Armory, crouch and scan the room
    for more Gothon that might be hiding. It's dead quiet, too quiet.
    You stand up and run to the far side of the rooom and find the
    ...
    THE_BRIDGE.add_paths({
        ...
        "slowy place the bomb" => ESCAPE_POD
      })
    ...
    # A white list of allowed room names. We use this so that
    # bad people on the internet can't access random variables
    # with names.  You can use Test::constants and Kernel.const_get too.
    ROOM_NAMES = {
    ...
    def Map::load_room(session)
      # Give a session this will return the right room or nil
